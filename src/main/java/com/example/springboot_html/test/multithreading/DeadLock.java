package com.example.springboot_html.test.multithreading;

/**
 * @author jiaohongtao
 * @description 死锁发生条件, 在写代码时要避免死锁
 * @since 2019/10/25 15:23
 */
 ...
 */
class Lock {
	static final Object lockOne = new Object();//资源A
	static final Object lockTwo = new Object();//资源B
}
